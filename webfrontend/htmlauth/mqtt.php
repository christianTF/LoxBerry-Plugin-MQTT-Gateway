...
function syntaxhelp()
{
	...
	print "<br>\n";
	print htmlentities("With transformer: http://" . "<user>:<pass>@ " . lbhostname() . ":" . lbwebserverport() . "/admin/plugins/mqttgateway/mqtt.php?retain=1&topic=homematic/temperature/livingroom&value=21.3&transform=mytransformer");
	print "<br>\n";
	exit(1);
}
